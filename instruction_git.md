...
=======
В программе git предусмотренна работа с удалёнными репозиториями. Удалённый репозиторий находится в интернете, на сайте, например Github, который считается основным хранилищем репозиторий. 

Удалённый репозиторий позволяет трудится почти везде, не только на работе. Можно подключится дома, скачать проект на чужой ноутбук и продолжить работать. А ещё можно работать большой командой над программой. Это позволяет программа git в свяске с github с чёткой и гибкой структурой проекта.

 Чтобы работать с удалёнными репозиториями необходимо зарегистрироваться на сайте github.
 Указать электронный ящик, придумать логин, имя.
>>>>>>> newbranch
...
Правило хорошего тона - сразу создаём свою ветку.

Закончив работать над пректом, отправляем обратно на удалённый репозиторий командой:
    
    git push --set apstream oring remoted

Переходим на сайт, в личный кабинет. Смотрим на запушенный репозиторий. Проверяем.
