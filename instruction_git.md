...
Просходит синхронизация файлов:

Теперь можно на сайте GitHub и в своей страничке увидеть свой полный репозиторий со всеми своими комментариями. Также идёт ослеживания изменений между локальной и удалённой репозитрория.
