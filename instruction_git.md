...
В программе git предусмотренна работа с удалёнными репозиториями. Репозиторий находится в интернете, на сайте, например Github, считается, что основное хранилище репозиторий. 

Удалённый репозиторий позволяет трудится не только на работе, а почти везде. Можно подключится дома, скачать проект на чужой ноутбук и продолжить работать. А ещё можно работать большой командой над программой. Это позволяет программа git в свяске с github с чёткой и гибкой структурой проекта.
